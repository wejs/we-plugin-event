...
describe('controller_cfnews', function () {
  ...
  describe('find', function() {
    it('cfnews.find should find, count and run res.ok', function (done) {
      var req = {};
      var res = {
        locals: {
          event: { id: 10 },
    ...
    // it('cfnews.findOne should run res.goTo for html request', function (done) {
    ...
    // it('cfnews.findOne should run res.ok for json request', function (done) {
  ...
  //   it('cfnews.findOne should run next if not find the preloaded record', function (done) {
  //     var req = {};
