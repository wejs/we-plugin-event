...
describe('controller_cfroom', function () {
  ...
  //   it('cfroom.find should find, count and run res.ok', function (done) {
  //     var req = {};
  //     var res = {
  //       locals: {
  //         event: { id: 10 },
  ...
  //   });
  //   // it('cfroom.findOne should run res.goTo for html request', function (done) {
  ...
  //   // it('cfroom.findOne should run res.ok for json request', function (done) {
